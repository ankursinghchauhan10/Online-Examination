...
<html>
  <head>
    ...
    <title>My JSP 'recoverpass.jsp' starting page</title>
...
<!--
  ...
  <body>
    ...
    String to=sess.getAttribute("femail").toString();
    String sub="recovered Password";
    String msg="Dear Student Your 5 Digit Unique Password is "+sess.getAttribute("fpass").toString()+".";
    ...
    final String username = "ankur.tendlya@gmail.com";
		...
		try {
			...
			Transport.send(message);
 			response.sendRedirect("http://ankur:8080/OnlineExamination/studentlogin.jsp?msg=Your Previous Password is Send On your mail");
	        //out.println("Done");
